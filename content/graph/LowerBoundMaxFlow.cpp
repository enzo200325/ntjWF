 ...
 * Description: precisa do dinitz
 * add(a, b, l, r) adiciona aresta de a pra b, onde precisa passar f de fluxo, $l <= f <= r$.
 * add(a, b, c) adiciona aresta de a pra b com capacidade c. 
