 ...
 * Description:  Resolve o problema de assignment (matriz n por n). 
 * Colocar os valores da matriz em 'a' (pode $< 0$). 
 * assignment() retorna um par com o valor do assignment minimo, e a coluna escolhida por cada linha
 * Time: $O(n^3)$. 
 * Status: 
 */
