 ...
 * Date:
 * License: 
 * Description: Prefix sum of inverse of arithmetic functions
...
* funcoes pra mandar pro solve: f(x) -> retorna o valor de f(x), F(x) -> retorna o valor da soma de prefixo de f(x), g(x) -> retorna o inverso de f(x)
 * Time: $O(N^{\frac{2}{3}})$
 * Status: Works
 */
